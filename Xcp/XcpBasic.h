#ifndef __XCP_BASIC_H_
#define __XCP_BASIC_H_
...
/* Returns 1 (TRUE) if new stimulation data is available */
  ...
  extern vuint8 XcpStimEventStatus( vuint8 event, vuint8 action );
...
//extern vuint32 ApplXcpGetIdData( vuint8 *pData, vuint8 id );
#endif
