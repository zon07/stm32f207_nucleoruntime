...
static vuint8 XcpWriteMta( vuint8 size, const BYTEPTR data )
{
#if defined ( XCP_ENABLE_CALIBRATION_MEM_ACCESS_BY_APPL ) || defined ( XCP_ENABLE_WRITE_EEPROM ) || defined ( XCP_ENABLE_WRITE_PROTECTION )
  vuint8 r;
#endif
...
static vuint8 XcpReadMta( vuint8 size, BYTEPTR data )
{
#if defined ( XCP_ENABLE_CALIBRATION_MEM_ACCESS_BY_APPL ) || defined ( XCP_ENABLE_READ_EEPROM ) || defined ( XCP_ENABLE_READ_PROTECTION )
  vuint8 r;
#endif
...
static void XcpFreeDaq( void )
{
  ...
  #if defined ( kXcpMaxEvent ) && ! defined ( XCP_ENABLE_DAQ_PRESCALER ) && ! defined ( XCP_ENABLE_STIM ) //FIXME
